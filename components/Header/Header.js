...
const Navbar = () => {
    ...
    const style = {
        themeSwitcher: `h-8 w-8 cursor-pointer text-gray-600 transition-all hover:text-white dark:text-gray-300`,
        wrapper: `sticky top-0 z-50 bg-black px-4 py-2 shadow-md dark:bg-gray-900 flex items-center justify-between space-x-6`,
        ...
        icons: `h-8 w-8 cursor-pointer text-gray-400 transition-all hover:text-white dark:text-gray-300 hover:white:text-white`,
